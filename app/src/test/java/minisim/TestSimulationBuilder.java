...
public class TestSimulationBuilder {
	...
	public void noBodiesIfNotSpecified() {
		Simulation sim = Simulation.builder().width(100).height(100).addForce(new Gravity(1e-10))
	...
	public void correctNumberOfBodies() {
		Simulation sim = Simulation.builder().nBodies(2).width(100).height(100).addForce(new Gravity(1e-10))
				.addForce(new Friction(0.99)).solidBorders().build();
